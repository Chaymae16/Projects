...
Create 2 sub classes: Sedan and Truck. The Truck class has
 a fieldas weight and has its own implementation of
  calculateSalePrice() method in which returned price is
...
class CarTester{
    public static void main(String[] args) {
        Truck t=new Truck(25000,"black",3100);
        System.out.println(t.calculateSalePrice());

        Sedan s=new Sedan(40000,"white",30);
